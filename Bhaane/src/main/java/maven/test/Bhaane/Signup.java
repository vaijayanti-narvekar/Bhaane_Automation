...
public class Signup {
	...
	public String signupUser(String first, String last, String mail, String mobNo, String pass,boolean makeUsernameDynamic) throws InterruptedException {
		...
		return test_data_email.split(":")[2];
	}
