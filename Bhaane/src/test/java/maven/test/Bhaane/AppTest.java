...
//	
//		
////	@Test(priority = 2, description = "Verify Filter Page")
...
//	}
//	
////	@Test(priority = 3, description = "Verify Product Details Page")
...
//	}
//	
////	@Test(priority = 4, description = "Check Go to Cart")
...
//				
//	}
//	@Test(priority = 2, description= "Increment the product quantity on cart page")
...
//	}
//	
//	@Test(priority = 3, description= "Decrement the product quantity on cart page")
...
//	
//	
////	@Test(priority = 1,description = "Check Facebook page")
...
//	}
//	
////	@Test(priority = 2,description = "Check Instagram page")
...
public class AppTest {
	...
	String password = "password234";
	String filter = "dresses";
	String productName = "kimberly dress";
	String size = "l";
	String last_generated_mail ="";
	...
	public void TestCase01() throws InterruptedException {	
		 ...
		 Signup signup = new Signup(driver);
		 signup.navigateWebPage();
		 last_generated_mail=signup.signupUser(firstname, lastname, mail, mobNo, password,true);
	...
	public void TestCase02() {
		...
		login.login(last_generated_mail, password);	
